    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid125", tween: [ "style", "${_play_pause}", "display", 'none', { fromValue: 'block'}], position: 47357, duration: 0, easing: "easeOutQuad" },
            ...
            dom: [
                {
                    ...
                    type: 'image',
                    rect: ['0px', '0px', '1008px', '572px', 'auto', 'auto'],
                    fill: ['rgba(0,0,0,0)', 'images/pause_icon6.png', '0px', '0px']
                }
            ],
            symbolInstances: [
            ]
            ...
            dom: [
                {
                    ...
                    id: 'play_icon',
                    rect: ['0px', '0px', '1008px', '572px', 'auto', 'auto'],
                    fill: ['rgba(0,0,0,0)', 'images/play_icon6.png', '0px', '0px']
                }
            ],
            symbolInstances: [
            ]
