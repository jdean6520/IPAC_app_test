...
var plSTF="both",ctrPlS="both",minPlW="0",maxPlW=undefined,plWidth="1008px",plHeight="572px";
...
preContent={
    dom: [
    {
        ...
        fill: ["rgba(0,0,0,0)",'images/preloader13.gif','0px','0px']
    }]};//simpleContent
